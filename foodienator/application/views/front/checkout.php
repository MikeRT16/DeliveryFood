    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <form action="<?php echo base_url().'checkout/index';?>" method="POST"
                ...
                <h3 class="mt-3">Detalles de envío</h3><hr>
                ...
                <p class="lead mb-0">Contra reembolso</p>
                ...
                <div>
                    ...
                    Volver al carrito</a>
                    <button type="submit" name="placeOrder" class="btn btn-success">Realizar pedido <i

<div class="container-fluid padding">
    <div class="row welcome text-center welcome">
        <div class="col-12">
            <h1 class="display-4">Restaurantes</h1>
        </div>
        <hr>
    </div>
</div>
        ...
        <div class="col-md-6 col-lg-4 d-flex align-items-stretch">
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text mb-0"><?php echo " Restaurante  " . $store['c_name']; ?></p>
                    <p class="card-text mb-0"><?php echo $store['address']; ?></p>
                    <hr>
                    <p class="card-text mb-0"></p>
                    <p class="card-text mb-0">HORARIO</p>
                    <p class="card-text mb-0"><?php echo $store['o_days']; ?></p>
                    <p class="card-text"><?php echo $store['o_hr']; ?> - <?php echo $store['c_hr']; ?></p>
                    <hr>
                    <a href="<?php echo base_url().'dish/list/'.$store['r_id']; ?>" class="btn btn-primary">Ver
                        Menu</a>
                </div>
            </div>
        </div>

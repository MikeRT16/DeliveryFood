<div class="container p-4">
    <div class="row welcome text-center welcome">
        <div class="col-12">
            <h1 class="display-4">Menu de <?php echo $res['name']; ?></h1>
        </div>
    </div>
    <div class="container res-card">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">
                Un festín de belleza te espera con platos súper delicioso creados con amor por nuestros maravillosos chefs.
                </p>
            </div>
        </div>
    </div>

    ...
    <div class="container my-3" style="border: 2px outset green;">
        ...
        <div class="invoice mb-3">
            <div class="row mb-3 p-3">
                <div class="col-6">
                    <h3 style="color:purple"><b>Sistema Delivery de Comida</b></h3>
                </div>
                <div class="col-6">
                ...
                <div class="col-6">
                    <br><br>
                    <p class="mb-0"><b>Numero de Orden:</b> <?php echo "#".$order['o_id']; ?></p>
                    <?php $cDate = strtotime($order['success-date']); ?>
                    <p class="mb-0"><b>Fecha de orden:</b> <?php echo date('d-M-Y',$cDate); ?></p>
                    <p class="mb-0"><b>Modo de pago:</b> Contra reembolso</p>
                </div>
                    ...
                    <table class="table responsive">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo 'C$'.$dish['price']; ?></td>
                            </tr>
                            <tr>
                                <td colspan="2"></td>
                                <td class="font-weight-bold">Total</td>
                                <td class="font-weight-bold"><?php echo 'C$'.$order['price'] ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <footer class="text-center">
            <p class="mb-0">Gracias por sus pedidos y por elegirnos!</p>
            <p>Esperamos verte de nuevo</p>
            <p>Para los términos y condiciones, visite www.Delicious & Heald.com</p>
        </footer>
    </div>

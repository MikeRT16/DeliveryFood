...
<body>
    <div class="wrapper mt-sm-5">
        ...
        ?>
        <h4 class="pb-4 border-bottom text-center"> Inicie sesión con cuenta</h4>
        <form action="<?php echo base_url().'login/authenticate' ;?>" name="loginform" id="loginform" method="POST">
            ...
            <div class="py-3 pb-4 border-bottom">
                ...
                <a href="<?php echo base_url().'singup/index' ?>" class="btn btn-danger">Registrar</a>
            </div>
        </form>
    </div>
    <script>
    ...
    const validate = () => {
        ...
        if (usernameVal === "") {
            setErrorMsg(username, 'El nombre de usuario puede estar en blanco');
        } else {
            setSuccessMsg(username);
        }

        if (passwordVal === "") {
            setErrorMsg(password, 'La contraseña no puede estar en blanco');
        } else {

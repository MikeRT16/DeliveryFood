...
<body>
    <div class="conatiner">
        <h1 class="text-center mt-3">Panel Admi</h1>
        <p class="text-center mb-4">Por favor, inicie sesión para continuar</p>
        <?php
      ...
      ?>
        <form action="<?php echo base_url().'admin/login/authenticate' ;?>" name="loginform" id="loginform"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control my-2" name="username" id="username" placeholder="Usuario">
                <span></span>
            </div>

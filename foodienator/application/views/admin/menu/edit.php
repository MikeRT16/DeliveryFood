<div class="conatiner">
    <form id="myForm" action="<?php echo base_url().'admin/menu/edit/'.$dish['d_id'];?>" method="POST"
        ...
        <h3 class="mb-3 text-center">Editar platillo "<?php echo $dish['name']; ?>"</h3>
        <div class="form-group">
            ...
            <select name="rname" id="resname"
                ...
                <option>--Selecciones un restaurante--</option>
                <?php 
                if (!empty($stores)) { 
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('name') != "") ? 'is-invalid' : '';?>" name="name" id="name"
                        placeholder="Ingrese el nombre del platillo" value="<?php echo set_value('name', $dish['name']); ?>">
                    <span></span>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('price') != "") ? 'is-invalid' : '';?>" id="price" name="price"
                        placeholder="Ingrese un precio" value="<?php echo set_value('price', $dish['price']); ?>">
                    <span></span>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <?php echo (form_error('about') != "") ? 'is-invalid' : '';?>" id="about" name="about"
                        placeholder="Descripcion" value="<?php echo set_value('about', $dish['about']); ?>">
                    <span></span>
        ...
        <button type="submit" class="btn btn-primary ml-2">Hacer cambios</button>
...
const validate = () => {
    ...
    if (resnameVal === "--Selecciones un restaurante--") {
    ...
    if (aboutVal === "") {
        setErrorMsg(about, 'Acerca de no puede estar en blanco');
    } else {
        setSuccessMsg(about);
    }

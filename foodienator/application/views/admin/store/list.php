        ...
        <div class="col-md-12">
            <table class="table table-striped table-responsive table-hover table-bordered">
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url().'admin/store/edit/'.$store['r_id']?>"
                                class="btn btn-info mb-1"><i class="fas fa-edit mr-1"></i>Editar</a>
                    ...
                    <?php } else {?>
                    <tr>
                        <td colspan="10">Registros no encontrados</td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
...
function deleteStore(id) {
    if (confirm("¿Está seguro de que desea eliminar la tienda?")) {

...
class Store extends CI_Controller {
        ...
        if($this->form_validation->run() == true) {
            ...
            if(!empty($_FILES['image']['name'])){
                ...
                if($this->upload->do_upload('image')) {
                    ...
                    $this->session->set_flashdata('res_success', 'Restaurante añadido correctamente');
    ...
    public function edit($id) {
        ...
        if(empty($store)) {
            $this->session->set_flashdata('error', 'Tienda no encontrada');
            redirect(base_url().'admin/store/index');
        }
        ...
        if($this->form_validation->run() == true) {
            ...
            if(!empty($_FILES['image']['name'])){
                ...
                if($this->upload->do_upload('image')) {
                    ...
                    $this->session->set_flashdata('res_success', 'Restaurante actualizado correctamente');
                    redirect(base_url(). 'admin/store/index');
    ...
    public function delete($id){
        ...
        if(empty($store)) {
            $this->session->set_flashdata('error', 'Restaurante no encontrado');
        ...
        $this->session->set_flashdata('res_success', 'Restaurante eliminado correctamente');
        redirect(base_url().'admin/store/index');

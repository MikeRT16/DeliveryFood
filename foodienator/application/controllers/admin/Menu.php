...
class Menu extends CI_Controller {
    public function __construct(){
        ...
        if(empty($admin)) {
            $this->session->set_flashdata('msg', 'Su sesión ha expirado');
        ...
        if($this->form_validation->run() == true) {
            ...
            if(!empty($_FILES['image']['name'])){
                ...
                if($this->upload->do_upload('image')) {
                    ...
                    $this->session->set_flashdata('dish_success', 'Menú agregado correctamente');
                ...
                $this->session->set_flashdata('dish_success', 'Platillo añadido correctamente');
                redirect(base_url(). 'admin/menu/index');
            }
    ...
    public function edit($id) {
        ...
        if(empty($dish)) {
            ...
            $this->session->set_flashdata('error', 'Platillo añadido correctamente');
            redirect(base_url(). 'admin/menu/index');
        }
        ...
        if($this->form_validation->run() == true) {
            ...
            if(!empty($_FILES['image']['name'])){
                ...
                if($this->upload->do_upload('image')) {
                    ...
                    $this->session->set_flashdata('dish_success', 'Platillo actualizado correctamente');
                    redirect(base_url(). 'admin/menu/index');
    ...
    public function delete($id){
        ...
        if(empty($dish)) {
            $this->session->set_flashdata('error', 'Platillo no encontrado');
        ...
        $this->session->set_flashdata('dish_success', 'Platillo eliminado correctamente');
        redirect(base_url().'admin/menu/index');
